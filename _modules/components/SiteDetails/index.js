...
var SiteDetails = exports.SiteDetails = function SiteDetails(props) {
  var site = props.site,
  ...
  var handlechangeImage = function handlechangeImage(file, name) {
    ...
    reader.onload = function () {
      setFormState(function (prev) {
        return _objectSpread(_objectSpread({}, prev), {}, {
          changes: _objectSpread(_objectSpread({}, prev.changes), {}, _defineProperty({}, name, reader.result))
        });
      });
    };
  };
  ...
  var handleUpdateSite = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_changes) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            changesToSend = _changes && _typeof(_changes) === 'object' ? _changes : formState.changes;
            if (!(!changesToSend || Object.keys(changesToSend).length === 0)) {
              _context.next = 4;
              break;
            }
    ...
    return function handleUpdateSite(_x) {
  ...
  var handleAddSite = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_changes) {
      var changesToSend, requestOptions, response, content;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            changesToSend = _changes && _typeof(_changes) === 'object' ? _objectSpread(_objectSpread({}, formState.changes), _changes) : formState.changes;
            if (!(!changesToSend || Object.keys(changesToSend).length === 0)) {
              _context3.next = 4;
              break;
            }
    ...
    return function handleAddSite(_x2) {
