...
var ReportsDriverGroupFilter = function ReportsDriverGroupFilter(props) {
  ...
  var getDriverGroups = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {
      var requestOptions, functionFetch, response, _yield$response$json, error, result, pagination, enabledDriverGroups;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              functionFetch = "".concat(ordering.root, "/drivergroups?params=").concat(propsToFetch);
              _context.next = 8;
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!(filterList === null || filterList === void 0 ? void 0 : filterList.driver_groups_ids) || (filterList === null || filterList === void 0 ? void 0 : (_filterList$driver_gr = filterList.driver_groups_ids) === null || _filterList$driver_gr === void 0 ? void 0 : _filterList$driver_gr.length) === (driverGroupList === null || driverGroupList === void 0 ? void 0 : driverGroupList.driverGroups.length)) setIsAllCheck(true);
