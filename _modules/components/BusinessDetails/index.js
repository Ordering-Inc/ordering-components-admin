...
var BusinessDetails = exports.BusinessDetails = function BusinessDetails(props) {
  ...
  var _props = props,
    asDashboard = _props.asDashboard,
    business = _props.business,
    businessId = _props.businessId,
    propsToFetch = _props.propsToFetch,
    UIComponent = _props.UIComponent,
    handleSucessUpdateBusiness = _props.handleSucessUpdateBusiness,
    handleSucessRemoveBusiness = _props.handleSucessRemoveBusiness,
    handleSucessAddBusiness = _props.handleSucessAddBusiness,
    notGetSites = _props.notGetSites,
    notGetTaxes = _props.notGetTaxes;
  ...
  var _useState11 = (0, _react.useState)({}),
    ...
    formTaxChanges = _useState12[0],
    setFormTaxChanges = _useState12[1];
  var _useState13 = (0, _react.useState)({}),
    _useState14 = _slicedToArray(_useState13, 2),
    taxes = _useState14[0],
    setTaxes = _useState14[1];
  ...
  var _useState17 = (0, _react.useState)({
    ...
    taxToEdit = _useState18[0],
    setTaxToEdit = _useState18[1];
  var _useState19 = (0, _react.useState)({
    ...
    formTaxState = _useState20[0],
    setFormTaxState = _useState20[1];
    ...
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            changes = _args7.length > 0 && _args7[0] !== undefined ? _args7[0] : {};
            _context7.prev = 1;
            setFormState(_objectSpread(_objectSpread({}, formState), {}, {
              loading: true
            }));
            showToast(_ToastContext.ToastType.Info, t('LOADING', 'Loading'));
            changesToSend = Object.keys(changes).length > 0 && !changes.target ? changes : formState.changes;
            _context7.next = 7;
            return ordering.businesses(businessId).save(changesToSend, {
  ...
  var getTaxes = /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
      var taxesObject, response, _yield$response$json3, error, result;
  ...
  var handleSaveTax = /*#__PURE__*/function () {
    var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(id, action, _data) {
      var _result, result, response, _yield$response$json4, data, _response, _yield$_response$json, _data2;
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          case 0:
            _context13.prev = 0;
            setFormTaxState(_objectSpread(_objectSpread({}, formState), {}, {
              loading: true
            }));
            showToast(_ToastContext.ToastType.Info, t('LOADING', 'Loading'));
            if (!id) {
            ...
            return fetch("".concat(ordering.root, "/").concat(action, "/").concat(id), {
              ...
              body: JSON.stringify(_objectSpread(_objectSpread({}, formTaxChanges), _data))
            });
          case 6:
            ...
            return response.json();
          case 9:
            _yield$response$json4 = _context13.sent;
            data = _yield$response$json4.result;
            result = data;
            if (action === 'taxes') {
              ...
              showToast(_ToastContext.ToastType.Success, t('TAX_SAVED', 'Tax saved'));
            } else {
              ...
              showToast(_ToastContext.ToastType.Success, t('FEE_SAVED', 'Fee saved'));
            }
            _context13.next = 24;
            break;
          case 15:
          ...
          case 20:
            _yield$_response$json = _context13.sent;
            _data2 = _yield$_response$json.result;
            if (action === 'taxes') {
              setTaxes(_objectSpread(_objectSpread({}, taxes), {}, _defineProperty({}, "id:".concat(_data2.id), {
                name: _data2.name,
                description: _data2.description,
                id: _data2.id,
                rate: _data2.rate,
                type: _data2.type,
                order_type_rates: _data2.order_type_rates || null
              })));
              showToast(_ToastContext.ToastType.Success, t('TAX_SAVED', 'Tax saved'));
            } else {
              setFees(_objectSpread(_objectSpread({}, fees), {}, _defineProperty({}, "id:".concat(_data2.id), {
                name: _data2.name,
                description: _data2.description,
                id: _data2.id,
                fixed: _data2.fixed,
            ...
            return _context13.abrupt("return", _data2);
          case 24:
      ...
      }, _callee13, null, [[0, 29, 32, 35]]);
    }));
    return function handleSaveTax(_x9, _x10, _x11) {
      return _ref15.apply(this, arguments);
    };
  }();
  var handleDeleteTax = /*#__PURE__*/function () {
    var _ref16 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(id, action) {
      var response, _yield$response$json5, error, newTaxes, newFees;
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          ...
          case 5:
            ...
            return response.json();
          case 8:
            _yield$response$json5 = _context14.sent;
            ...
            if (!error) {
              if (action === 'taxes') {
                ...
                setTaxes(newTaxes);
                showToast(_ToastContext.ToastType.Success, t('TAX_DELETED', 'tax deleted'));
              } else {
                newFees = fees;
                ...
                setFees(newFees);
                showToast(_ToastContext.ToastType.Success, t('FEE_DELETED', 'Fee deleted'));
              }
            }
          case 11:
            setFormTaxState(_objectSpread(_objectSpread({}, formTaxState), {}, {
    ...
    return function handleDeleteTax(_x12, _x13) {
