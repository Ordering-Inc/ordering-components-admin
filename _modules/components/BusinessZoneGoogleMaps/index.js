...
var BusinessZoneGoogleMaps = function BusinessZoneGoogleMaps(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!((_window$google = window.google) === null || _window$google === void 0 ? void 0 : _window$google.maps)) return;
    ...
    if (clearState) {
      ...
      if ((_window$google$maps = window.google.maps) === null || _window$google$maps === void 0 ? void 0 : (_window$google$maps$d = _window$google$maps.drawing) === null || _window$google$maps$d === void 0 ? void 0 : _window$google$maps$d.DrawingManager) {
  ...
  (0, _react.useEffect)(function () {
    if (googleReady) {
      ...
      if ((_window$google$maps2 = window.google.maps) === null || _window$google$maps2 === void 0 ? void 0 : (_window$google$maps2$ = _window$google$maps2.drawing) === null || _window$google$maps2$ === void 0 ? void 0 : _window$google$maps2$.DrawingManager) {
        var _drawingManager = new window.google.maps.drawing.DrawingManager({
          drawingControl: true,
          drawingControlOptions: {
            position: window.google.maps.ControlPosition.TOP_CENTER,
