...
var BusinessProductsListing = function BusinessProductsListing(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!businessState.loading && (categorySelected || isAllCategoryProducts)) {
      getProducts(true);
    } else if (businessState === null || businessState === void 0 ? void 0 : (_businessState$busine8 = businessState.business) === null || _businessState$busine8 === void 0 ? void 0 : _businessState$busine8.categories) {
