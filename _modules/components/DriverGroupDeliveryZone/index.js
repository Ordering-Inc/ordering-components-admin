...
var DriverGroupDeliveryZone = exports.DriverGroupDeliveryZone = function DriverGroupDeliveryZone(props) {
    ...
    if (e.target.name === 'distance') {
      setFormState(_objectSpread(_objectSpread({}, formState), {}, {
        changes: _objectSpread(_objectSpread({}, formState.changes), {}, {
          data: _defineProperty(_defineProperty({}, e.target.name, e.target.value), "unit", unit)
        })
      }));
    } else {
      setFormState(_objectSpread(_objectSpread({}, formState), {}, {
