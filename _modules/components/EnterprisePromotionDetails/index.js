...
var EnterprisePromotionDetails = function EnterprisePromotionDetails(props) {
  ...
  var handleUpdateClick = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _promotion$id, _promotionState$promo, changes, key, requestOptions, response, content, updatedPromotions;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return fetch("".concat(ordering.root, "/offers/").concat((_promotion$id = promotion.id) !== null && _promotion$id !== void 0 ? _promotion$id : (_promotionState$promo = promotionState.promotion) === null || _promotionState$promo === void 0 ? void 0 : _promotionState$promo.id), requestOptions);
