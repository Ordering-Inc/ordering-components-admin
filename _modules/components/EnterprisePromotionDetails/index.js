...
var EnterprisePromotionDetails = function EnterprisePromotionDetails(props) {
  ...
  var handleSelectSite = function handleSelectSite(checked, siteId) {
    ...
    if ((_formState$changes = formState.changes) === null || _formState$changes === void 0 ? void 0 : _formState$changes.sites) {
      ...
      if (promotion === null || promotion === void 0 ? void 0 : promotion.sites) {
