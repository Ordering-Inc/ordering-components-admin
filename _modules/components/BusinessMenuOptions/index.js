...
var BusinessMenuOptions = function BusinessMenuOptions(props) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              if (changes === null || changes === void 0 ? void 0 : changes.products) {
                changes.products = JSON.stringify(changes === null || changes === void 0 ? void 0 : changes.products);
              }

              if (changes === null || changes === void 0 ? void 0 : changes.schedule) {
            ...
            case 12:
              ...
              if (!content.error) {
                ...
                if (changes === null || changes === void 0 ? void 0 : changes.all_products) {
  ...
  var handleSetSubCategoryList = function handleSetSubCategoryList(_selectedProductsIds) {
    if (business === null || business === void 0 ? void 0 : business.categories.length) {
