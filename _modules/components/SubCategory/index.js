...
var SubCategory = function SubCategory(props) {
  ...
  var getSubCategory = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = 6;
              return ordering.configs(categoryId).get();
    ...
    return function getSubCategory() {
  ...
  var saveConfiguartion = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(changes) {
      var _yield$ordering$confi3, _yield$ordering$confi4, error, result;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              _context2.next = 6;
              return ordering.configs(categoryId).save(changes);
    ...
    return function saveConfiguartion(_x) {
