...
var DriversGroupDetails = exports.DriversGroupDetails = function DriversGroupDetails(props) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            changes = _changes;
            skipeableValues = ['', '[]'];
            (_Object$keys = Object.keys(changes)) === null || _Object$keys === void 0 || _Object$keys.map(function (changeName) {
              var _changes2;
  ...
  var handleChangesState = function handleChangesState(changes) {
    ...
    var enterToValidation = Object === null || Object === void 0 || (_Object$keys2 = Object.keys(mergedChanges)) === null || _Object$keys2 === void 0 ? void 0 : _Object$keys2.filter(function (changeName) {
