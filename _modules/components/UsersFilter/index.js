...
var UsersFilter = function UsersFilter(props) {
  ...
  var handleChangeInput = function handleChangeInput(name, val) {
    setFilterState(_objectSpread(_objectSpread({}, filterState), {}, {
      changes: _objectSpread(_objectSpread({}, filterState.changes), {}, _defineProperty({}, name, val))
    }));
  };
...
UsersFilter.propTypes = {
   ...
   */
  setFilterValues: _propTypes.default.func,
