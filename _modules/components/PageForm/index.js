                ...
                if (handleSuccessUpdate) {
                  updatedPages = pageList.filter(function (page) {
                    if (page.id === pageId) {
                      ...
                      page.name = ((_formState$changes = formState.changes) === null || _formState$changes === void 0 ? void 0 : _formState$changes.name) ? (_formState$changes2 = formState.changes) === null || _formState$changes2 === void 0 ? void 0 : _formState$changes2.name : page === null || page === void 0 ? void 0 : page.name;
