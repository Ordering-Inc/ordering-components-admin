  ...
  var isFilteredOrder = function isFilteredOrder(order, lastHistoryData) {
    ...
    if (searchValue) {
      ...
      if (isSearchByOrderId) {
        ...
        if (((order === null || order === void 0 ? void 0 : (_order$id = order.id) === null || _order$id === void 0 ? void 0 : _order$id.toString()) || '').toLowerCase().includes(searchValue.toLowerCase())) searchCheck = true;
      }

      if (isSearchByCustomerEmail) {
        var _order$customer;

        if (((order === null || order === void 0 ? void 0 : (_order$customer = order.customer) === null || _order$customer === void 0 ? void 0 : _order$customer.email) || '').toLowerCase().includes(searchValue.toLowerCase())) searchCheck = true;
      }

      if (isSearchByCustomerPhone) {
        var _order$customer2;

        if (((order === null || order === void 0 ? void 0 : (_order$customer2 = order.customer) === null || _order$customer2 === void 0 ? void 0 : _order$customer2.cellphone) || '').toLowerCase().includes(searchValue.toLowerCase())) searchCheck = true;
      }

      if (isSearchByBusinessName) {
        var _order$business;

        if (((order === null || order === void 0 ? void 0 : (_order$business = order.business) === null || _order$business === void 0 ? void 0 : _order$business.name) || '').toLowerCase().includes(searchValue.toLowerCase())) searchCheck = true;
      }

      if (isSearchByDriverName) {
        var _order$driver;

        if (((order === null || order === void 0 ? void 0 : (_order$driver = order.driver) === null || _order$driver === void 0 ? void 0 : _order$driver.name) || '').toLowerCase().includes(searchValue.toLowerCase())) searchCheck = true;
      }
  ...
  (0, _react.useEffect)(function () {
    ...
    var handleUpdateOrder = function handleUpdateOrder(order) {
      ...
      if (!isFilteredOrder(order)) {
        ...
        var lastHistoryData = order === null || order === void 0 ? void 0 : (_order$history = order.history[length - 1]) === null || _order$history === void 0 ? void 0 : _order$history.data;
        ...
        var _found = orderList.orders.find(function (_order) {
          return (_order === null || _order === void 0 ? void 0 : _order.id) === (order === null || order === void 0 ? void 0 : order.id);
        });
      ...
      if (found) {
        ...
        if (order !== null && order !== void 0 && order.history) {
          var _order$history2, _order$history3;

          var _length = order === null || order === void 0 ? void 0 : (_order$history2 = order.history) === null || _order$history2 === void 0 ? void 0 : _order$history2.length;

          var _lastHistoryData = order === null || order === void 0 ? void 0 : (_order$history3 = order.history[_length - 1]) === null || _order$history3 === void 0 ? void 0 : _order$history3.data;

          statusChange = _lastHistoryData === null || _lastHistoryData === void 0 ? void 0 : _lastHistoryData.find(function (_ref9) {
