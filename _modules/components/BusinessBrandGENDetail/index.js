...
var BusinessBrandGENDetail = function BusinessBrandGENDetail(props) {
  ...
  var updateBrand = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
      var changes, key, requestOptions, response, content, _formState$changes, _formState$changes$ri, _formState$changes2, _formState$changes2$r, _content$result, _content$result$ribbo, updatedChanges, Options, _response, _content, _brands, _brands2;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 21:
              ...
              if (handleUpdateBrandList) {
                _brands = brandListState === null || brandListState === void 0 ? void 0 : brandListState.brands.map(function (item) {
                  if (item.id === _content.result.id) {
                    return _objectSpread(_objectSpread({}, item), _content.result);
                  }
            ...
            case 26:
              ...
              if (handleUpdateBrandList) {
                _brands2 = brandListState === null || brandListState === void 0 ? void 0 : brandListState.brands.map(function (item) {
                ...
                handleUpdateBrandList(_brands2);
              }
