              ...
              if (!content.error) {
                updatedPages = pagesListState.pages.filter(function (page) {
                  if (page.id === editPageId) {
                    ...
                    page.name = ((_changeState$changes = changeState.changes) === null || _changeState$changes === void 0 ? void 0 : _changeState$changes.name) ? (_changeState$changes2 = changeState.changes) === null || _changeState$changes2 === void 0 ? void 0 : _changeState$changes2.name : page === null || page === void 0 ? void 0 : page.name;
