          ...
          switch (_context.prev = _context.next) {
            ...
            case 13:
              ...
              setBusinessState(_objectSpread(_objectSpread({}, businessState), {}, {
                business: _objectSpread(_objectSpread({}, businessState.business), _response.content.result)
              }));

              if (handleSuccessUpdate) {
                handleSuccessUpdate(_response.content.result);
              }

              if (handleUpdateBusinessState) {
                handleUpdateBusinessState(_response.content.result);
              }
