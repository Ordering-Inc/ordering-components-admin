...
var UserExport = function UserExport(props) {
  ...
  var getCSV = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(filterApply) {
      var requestOptions, filterConditions, functionFetch, response, fileSuffix;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              functionFetch = filterApply ? "".concat(ordering.root, "/users.csv?mode=dashboard&orderBy=id&where=").concat(JSON.stringify(filterConditions)) : "".concat(ordering.root, "/users.csv?mode=dashboard&orderBy=id");
              _context.next = 10;
