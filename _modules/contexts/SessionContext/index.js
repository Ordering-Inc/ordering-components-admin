...
var SessionProvider = function SessionProvider(_ref) {
  ...
  var checkLocalStorage = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee6() {
      var _yield$getValuesFromL2, token, user, allowedUserLevels;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              ...
              allowedUserLevels = [0, 2, 5];

              if (token && allowedUserLevels.includes(user === null || user === void 0 ? void 0 : user.level) && !state.token) {
                login({
                  user: user,
                  token: token
                });
              ...
              if (!token && state.token || !allowedUserLevels.includes(user === null || user === void 0 ? void 0 : user.level)) {
                logout();
              }
