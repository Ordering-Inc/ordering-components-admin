...
var SiteProvider = function SiteProvider(_ref) {
  ...
  var _useState = (0, _react.useState)([]),
      ...
      siteList = _useState2[0],
      setSiteList = _useState2[1];

  var getSiteList = /*#__PURE__*/function () {
    ...
    return function getSiteList() {
      return _ref2.apply(this, arguments);
    };
  }();

  var changeSiteList = function changeSiteList(data) {
    setSiteList(data);
  };
